...
var CreateRegionDto = function () {
    var _a;
    var _countryIds_decorators;
    var _countryIds_initializers = [];
    var _countryIds_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function CreateRegionDto() {
                this.countryIds = __runInitializers(this, _countryIds_initializers, void 0);
                this.name = (__runInitializers(this, _countryIds_extraInitializers), __runInitializers(this, _name_initializers, void 0));
                ...
                this.metadata = (__runInitializers(this, _automatic_taxes_extraInitializers), __runInitializers(this, _metadata_initializers, void 0));
        ...
        (function () {
            ...
            _countryIds_decorators = [(0, class_validator_1.IsString)()];
            _name_decorators = [(0, class_validator_1.IsString)()];
            _currency_code_decorators = [(0, class_validator_1.IsString)()];
            _automatic_taxes_decorators = [(0, class_validator_1.IsBoolean)(), (0, class_validator_1.IsOptional)()];
            _metadata_decorators = [(0, class_validator_1.IsOptional)()];
            __esDecorate(null, null, _countryIds_decorators, { kind: "field", name: "countryIds", static: false, private: false, access: { has: function (obj) { return "countryIds" in obj; }, get: function (obj) { return obj.countryIds; }, set: function (obj, value) { obj.countryIds = value; } }, metadata: _metadata }, _countryIds_initializers, _countryIds_extraInitializers);
