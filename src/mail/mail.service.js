...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.sendVerificationCode = function (email, code) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.mailerService.sendMail({
                                    ...
                                    text: "Voici votre code de v\u00E9rification : ".concat(code),
                                    html: "<p>Voici votre code de v\u00E9rification : <strong>".concat(code, "</strong></p>"),
                                })];
                        case 1:
                            info = _a.sent();
