...
exports.PriceListRuleSchema = exports.PriceListRule = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var PriceListRule = function () {
    ...
    var PriceListRule = _classThis = /** @class */ (function () {
        function PriceListRule_1() {
            ...
            this.deleted_at = (__runInitializers(this, _price_list_extraInitializers), __runInitializers(this, _deleted_at_initializers, void 0));
            __runInitializers(this, _deleted_at_extraInitializers);
        }
        return PriceListRule_1;
    }());
    __setFunctionName(_classThis, "PriceListRule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _attribute_decorators = [(0, mongoose_1.Prop)({ type: String, required: true, index: true })];
        _value_decorators = [(0, mongoose_1.Prop)({ type: Object, default: null })];
        _price_list_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: 'PriceList', required: true })];
        ...
        PriceListRule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PriceListRule = _classThis;
}();
exports.PriceListRule = PriceListRule;
exports.PriceListRuleSchema = mongoose_1.SchemaFactory.createForClass(PriceListRule);
