...
exports.PriceSetSchema = exports.PriceSet = void 0;
...
var PriceSet = function () {
    ...
    var PriceSet = _classThis = /** @class */ (function (_super) {
        __extends(PriceSet_1, _super);
        function PriceSet_1() {
    ...
    __setFunctionName(_classThis, "PriceSet");
    (function () {
        var _a;
        ...
        PriceSet = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PriceSet = _classThis;
}();
exports.PriceSet = PriceSet;
exports.PriceSetSchema = mongoose_1.SchemaFactory.createForClass(PriceSet);
