...
exports.CreateMoneyAmountDTO = void 0;
var class_validator_1 = require("class-validator");
var CreateMoneyAmountDTO = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateMoneyAmountDTO() {
                ...
                this.variant_id = (__runInitializers(this, _currency_code_extraInitializers), __runInitializers(this, _variant_id_initializers, void 0)); // Pour lier à un ProductVariant directement si souhaité
                __runInitializers(this, _variant_id_extraInitializers);
            }
            return CreateMoneyAmountDTO;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _amount_decorators = [(0, class_validator_1.IsNumber)()];
            _currency_code_decorators = [(0, class_validator_1.IsString)()];
            _variant_id_decorators = [(0, class_validator_1.IsOptional)()];
...
exports.CreateMoneyAmountDTO = CreateMoneyAmountDTO;
