...
exports.CreatePriceSetDto = void 0;
var class_validator_1 = require("class-validator");
var CreatePriceSetDto = function () {
    var _a;
    var _prices_decorators;
    var _prices_initializers = [];
    var _prices_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreatePriceSetDto() {
                this.prices = __runInitializers(this, _prices_initializers, void 0);
                __runInitializers(this, _prices_extraInitializers);
            }
            return CreatePriceSetDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _prices_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.IsMongoId)({ each: true })];
...
exports.CreatePriceSetDto = CreatePriceSetDto;
