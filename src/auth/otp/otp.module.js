...
var OtpModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forFeature([{ name: otp_entity_1.Otp.name, schema: otp_entity_1.OtpSchema }]),
            ],
    ...
    var _classThis;
    var OtpModule = _classThis = /** @class */ (function () {
        function OtpModule_1() {
        }
        return OtpModule_1;
    }());
    __setFunctionName(_classThis, "OtpModule");
    (function () {
