...
var useCollectionActions = function (collection) {
    var dialog = (0, use_imperative_dialog_1.default)();
    var deleteCollection = (0, medusa_react_1.useAdminDeleteCollection)(collection === null || collection === void 0 ? void 0 : collection.id);
    ...
    var getActions = function (coll) { return [
        {
            label: "Edit",
            onClick: function () { return (0, gatsby_1.navigate)("/a/collections/".concat(coll.id)); },
...
exports.default = useCollectionActions;
