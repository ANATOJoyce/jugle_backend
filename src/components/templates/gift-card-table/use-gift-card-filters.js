...
exports.useGiftCardFilters = void 0;
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case "setFilters": {
            return __assign(__assign({}, state), { fulfillment: action.payload.fulfillment, payment: action.payload.payment, status: action.payload.status, date: action.payload.date, query: (_a = action === null || action === void 0 ? void 0 : action.payload) === null || _a === void 0 ? void 0 : _a.query });
        }
        case "setQuery": {
...
var useGiftCardFilters = function (existing, defaultFilters) {
    ...
    var initialTabs = (0, react_1.useMemo)(function () {
        var storageString = localStorage.getItem("GiftCards::filters");
        if (storageString) {
    ...
    var reset = function () {
        dispatch({
            type: "setFilters",
            payload: __assign(__assign({}, state), { offset: 0, payment: {
                    open: false,
                    filter: null,
                }, fulfillment: {
                    open: false,
    ...
    var saveTab = function (tabName, filters) {
        ...
        var storedString = localStorage.getItem("GiftCards::filters");
        var existing = null;
        if (storedString) {
...
exports.useGiftCardFilters = useGiftCardFilters;
var filterStateMap = {
    status: "status",
