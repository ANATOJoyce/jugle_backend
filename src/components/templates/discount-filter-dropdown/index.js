...
var dynamicFilters = ["normal", "dynamic"];
var dateFilters = [
    "is in the last",
    "is older than",
    "is between",
...
var DiscountFilters = function (_a) {
    ...
    return (<div className="flex space-x-1">
      <container_1.default submitFilters={onSubmit} clearFilters={onClear} triggerElement={<button className={(0, clsx_1.default)("flex rounded-rounded items-center space-x-1 focus-visible:outline-none focus-visible:shadow-input focus-visible:border-violet-60")}>
        ...
        <item_1.default filterTitle="Types" options={dynamicFilters} filters={tempState.isDynamic.filter} open={tempState.isDynamic.open} setFilter={function (val) { return setSingleFilter("isDynamic", val); }}/>
...
exports.default = DiscountFilters;
