...
exports.useProductFilters = void 0;
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case "setFilters": {
            return __assign(__assign({}, state), { status: action.payload.status, collection: action.payload.collection, tags: action.payload.tags, date: action.payload.date, query: (_a = action === null || action === void 0 ? void 0 : action.payload) === null || _a === void 0 ? void 0 : _a.query });
        }
        case "setQuery": {
...
var useProductFilters = function (existing, defaultFilters) {
    ...
    var initialTabs = (0, react_1.useMemo)(function () {
        var storageString = localStorage.getItem("products::filters");
        if (storageString) {
    ...
    var reset = function () {
        dispatch({
            type: "setFilters",
            payload: __assign(__assign({}, state), { offset: 0, status: {
                    open: false,
                    filter: null,
                }, collection: {
                    open: false,
    ...
    var saveTab = function (tabName, filters) {
        ...
        var storedString = localStorage.getItem("products::filters");
        var existing = null;
        if (storedString) {
        ...
        setTabs(function (prev) {
            var duplicate = prev.findIndex(function (prev) { var _a; return ((_a = prev.label) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === tabName.toLowerCase(); });
            if (duplicate !== -1) {
