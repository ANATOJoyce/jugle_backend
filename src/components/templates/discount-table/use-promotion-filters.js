...
exports.usePromotionFilters = void 0;
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case "setFilters": {
            return __assign(__assign({}, state), { query: (_a = action === null || action === void 0 ? void 0 : action.payload) === null || _a === void 0 ? void 0 : _a.query, isDynamic: action.payload.isDynamic, date: action.payload.date });
        }
        case "setQuery": {
...
var usePromotionFilters = function (existing, defaultFilters) {
    ...
    var initialTabs = (0, react_1.useMemo)(function () {
        var storageString = localStorage.getItem("promotions::filters");
        if (storageString) {
    ...
    var reset = function () {
        dispatch({
            type: "setFilters",
            payload: __assign(__assign({}, state), { offset: 0, date: {
                    open: false,
                    filter: null,
                }, isDynamic: {
                    open: false,
    ...
    var saveTab = function (tabName, filters) {
        ...
        var storedString = localStorage.getItem("promotions::filters");
        var existing = null;
        if (storedString) {
...
exports.usePromotionFilters = usePromotionFilters;
var filterStateMap = {
