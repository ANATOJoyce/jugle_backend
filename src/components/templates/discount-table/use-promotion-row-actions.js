...
var use_copy_promotion_1 = require("./use-copy-promotion");
var usePromotionActions = function (promotion) {
    var notification = (0, use_notification_1.default)();
    var dialog = (0, use_imperative_dialog_1.default)();
    var copyPromotion = (0, use_copy_promotion_1.default)();
    var updatePromotion = (0, medusa_react_1.useAdminUpdateDiscount)(promotion.id);
    var deletePromotion = (0, medusa_react_1.useAdminDeleteDiscount)(promotion === null || promotion === void 0 ? void 0 : promotion.id);
    ...
    var getRowActions = function () {
        return [
            {
                label: "Edit",
                icon: <edit_icon_1.default size={20}/>,
                onClick: function () { return (0, gatsby_1.navigate)("/a/discounts/".concat(promotion.id)); },
            },
            {
                label: promotion.is_disabled ? "Publish" : "Unpublish",
                icon: promotion.is_disabled ? (<publish_icon_1.default size={20}/>) : (<unpublish_icon_1.default size={20}/>),
                onClick: function () {
                    updatePromotion.mutate({
                        is_disabled: !promotion.is_disabled,
                    }, {
                        onSuccess: function () {
                            notification("Success", "Successfully ".concat(promotion.is_disabled ? "published" : "unpublished", " discount"), "success");
                        },
            ...
            },
            {
                ...
                onClick: function () { return copyPromotion(promotion); },
            },
            {
                label: "Delete",
...
exports.default = usePromotionActions;
