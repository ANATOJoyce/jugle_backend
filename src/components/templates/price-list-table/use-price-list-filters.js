...
exports.usePriceListFilters = void 0;
var lodash_1 = require("lodash");
var qs_1 = require("qs");
var react_1 = require("react");
var equals_set_1 = require("../../../utils/equals-set");
var time_1 = require("../../../utils/time");
var allowedFilters = ["type", "customer_groups", "status", "offset", "limit"];
var DefaultTabs = {};
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case "setFilters": {
            return __assign(__assign({}, state), { query: (_a = action === null || action === void 0 ? void 0 : action.payload) === null || _a === void 0 ? void 0 : _a.query, status: action.payload.status, type: action.payload.type, customer_groups: action.payload.customer_groups });
        }
        case "setQuery": {
...
var usePriceListFilters = function (existing, defaultFilters) {
    ...
    var initialTabs = (0, react_1.useMemo)(function () {
        var storageString = localStorage.getItem("priceLists::filters");
        if (storageString) {
    ...
    var reset = function () {
        dispatch({
            type: "setFilters",
            payload: __assign(__assign({}, state), { offset: 0, type: {
                    open: false,
                    filter: null,
                }, status: {
                    open: false,
                    ...
                    if (Array.isArray(value)) {
                        match =
                            Array.isArray(clean[filter]) &&
                                (0, equals_set_1.setsEqual)(new Set(clean[filter]), new Set(value));
                    }
                    else {
    ...
    var availableTabs = (0, react_1.useMemo)(function () {
        return __spreadArray([], tabs, true);
    }, [tabs]);
    var setTab = function (tabName) {
        ...
        if (tabToUse) {
            var toSubmit = __assign(__assign({}, state), { type: {
                    open: false,
                    filter: null,
                }, status: {
                    open: false,
    ...
    var saveTab = function (tabName, filters) {
        ...
        var storedString = localStorage.getItem("priceLists::filters");
        var existing = null;
        if (storedString) {
...
exports.usePriceListFilters = usePriceListFilters;
var filterStateMap = {
    status: "status",
    type: "type",
