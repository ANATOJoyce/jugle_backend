...
exports.CreateOrderTransactionDto = void 0;
var class_validator_1 = require("class-validator");
var CreateOrderTransactionDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateOrderTransactionDto() {
                this.order = __runInitializers(this, _order_initializers, void 0); // correspond à l'ObjectId de la commande
                this.amount = (__runInitializers(this, _order_extraInitializers), __runInitializers(this, _amount_initializers, void 0));
                ...
                this.return = (__runInitializers(this, _reference_id_extraInitializers), __runInitializers(this, _return_initializers, void 0));
            ...
            return CreateOrderTransactionDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _order_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _amount_decorators = [(0, class_validator_1.IsNumber)()];
            _currency_code_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _reference_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _reference_id_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _return_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _exchange_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _claim_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
...
exports.CreateOrderTransactionDto = CreateOrderTransactionDto;
