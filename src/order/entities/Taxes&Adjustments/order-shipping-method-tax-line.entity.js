...
exports.OrderShippingMethodTaxLineSchema = exports.OrderShippingMethodTaxLine = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var OrderShippingMethodTaxLine = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({ collection: 'order_shipping_method_tax_lines', timestamps: true })];
    ...
    var OrderShippingMethodTaxLine = _classThis = /** @class */ (function (_super) {
        __extends(OrderShippingMethodTaxLine_1, _super);
        function OrderShippingMethodTaxLine_1() {
        ...
        return OrderShippingMethodTaxLine_1;
    }(_classSuper));
    __setFunctionName(_classThis, "OrderShippingMethodTaxLine");
    (function () {
        var _a;
        ...
        OrderShippingMethodTaxLine = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrderShippingMethodTaxLine = _classThis;
}();
exports.OrderShippingMethodTaxLine = OrderShippingMethodTaxLine;
exports.OrderShippingMethodTaxLineSchema = mongoose_1.SchemaFactory.createForClass(OrderShippingMethodTaxLine);
