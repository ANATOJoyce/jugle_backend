...
exports.OrderLineItemAdjustmentSchema = exports.OrderLineItemAdjustment = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var OrderLineItemAdjustment = function () {
    var _classDecorators = [(0, mongoose_1.Schema)({
            ...
            toJSON: {
                transform: function (doc, ret) {
                    ret.id = "ordliadj_".concat(doc._id.toString());
                    delete ret._id;
                    delete ret.__v;
                    return ret;
                },
    ...
    var OrderLineItemAdjustment = _classThis = /** @class */ (function (_super) {
        __extends(OrderLineItemAdjustment_1, _super);
        function OrderLineItemAdjustment_1() {
        ...
        return OrderLineItemAdjustment_1;
    }(_classSuper));
    __setFunctionName(_classThis, "OrderLineItemAdjustment");
    (function () {
        var _a;
        ...
        _amount_decorators = [(0, mongoose_1.Prop)({ type: String, required: true })];
        ...
        OrderLineItemAdjustment = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrderLineItemAdjustment = _classThis;
}();
exports.OrderLineItemAdjustment = OrderLineItemAdjustment;
exports.OrderLineItemAdjustmentSchema = mongoose_1.SchemaFactory.createForClass(OrderLineItemAdjustment);
