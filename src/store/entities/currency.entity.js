...
exports.StoreCurrencySchema = exports.StoreCurrency = void 0;
...
var StoreCurrency = function () {
    ...
    var StoreCurrency = _classThis = /** @class */ (function (_super) {
        ...
        function StoreCurrency_1() {
            ...
            _this.currency_code = __runInitializers(_this, _currency_code_initializers, void 0);
            _this.is_default = (__runInitializers(_this, _currency_code_extraInitializers), __runInitializers(_this, _is_default_initializers, void 0));
            _this.store = (__runInitializers(_this, _is_default_extraInitializers), __runInitializers(_this, _store_initializers, void 0)); // Nullable reference
            __runInitializers(_this, _store_extraInitializers);
            return _this;
        }
    ...
    (function () {
        ...
        _store_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: 'Store', default: null })];
...
exports.StoreCurrencySchema = mongoose_1.SchemaFactory.createForClass(StoreCurrency);
