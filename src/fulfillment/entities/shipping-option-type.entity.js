...
exports.ShippingOptionTypeSchema = exports.ShippingOptionType = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var ShippingOptionType = function () {
    ...
    var ShippingOptionType = _classThis = /** @class */ (function () {
        function ShippingOptionType_1() {
        ...
        return ShippingOptionType_1;
    }());
    __setFunctionName(_classThis, "ShippingOptionType");
    (function () {
        ...
        _id_decorators = [(0, mongoose_1.Prop)({
                ...
                required: true,
                unique: true,
                default: function () { return "sotype_".concat(new mongoose_2.Types.ObjectId().toString()); },
            })];
        _label_decorators = [(0, mongoose_1.Prop)({ type: String, required: true })];
        ...
        ShippingOptionType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ShippingOptionType = _classThis;
}();
exports.ShippingOptionType = ShippingOptionType;
exports.ShippingOptionTypeSchema = mongoose_1.SchemaFactory.createForClass(ShippingOptionType);
