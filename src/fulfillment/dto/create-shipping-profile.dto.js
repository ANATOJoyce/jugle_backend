...
exports.CreateShippingProfileDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var CreateShippingProfileDto = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
            function CreateShippingProfileDto() {
            ...
            return CreateShippingProfileDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [(0, swagger_1.ApiProperty)({ example: 'sp_60c72b2f9b1e8c001cf9fabd', description: 'Unique ShippingProfile ID' }), (0, class_validator_1.IsString)()];
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Express Delivery', description: 'Name of the shipping profile' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _type_decorators = [(0, swagger_1.ApiProperty)({ example: 'express', description: 'Type of the shipping profile' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _shipping_options_decorators = [(0, swagger_1.ApiProperty)({ example: ['60c72b2f9b1e8c001cf9faa1'], description: 'Array of ShippingOption IDs', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsMongoId)({ each: true })];
            _metadata_decorators = [(0, swagger_1.ApiProperty)({ example: {}, description: 'Additional metadata', required: false, nullable: true }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsObject)()];
            _deleted_at_decorators = [(0, swagger_1.ApiProperty)({ example: null, description: 'Soft delete date', required: false, nullable: true }), (0, class_validator_1.IsOptional)()];
