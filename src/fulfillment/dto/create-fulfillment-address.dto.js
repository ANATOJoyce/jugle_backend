...
exports.CreateFulfillmentAddressDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var CreateFulfillmentAddressDto = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
            function CreateFulfillmentAddressDto() {
                this.id = __runInitializers(this, _id_initializers, void 0);
                this.fulfillment = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _fulfillment_initializers, void 0));
                this.company = (__runInitializers(this, _fulfillment_extraInitializers), __runInitializers(this, _company_initializers, void 0));
            ...
            return CreateFulfillmentAddressDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [(0, swagger_1.ApiProperty)({ description: 'Unique ID with prefix "fuladdr"', example: 'fuladdr_x1y2z3a4b' }), (0, class_validator_1.IsString)()];
            _fulfillment_decorators = [(0, swagger_1.ApiProperty)({ description: 'ID of the parent fulfillment', example: 'ful_xxx' }), (0, class_validator_1.IsString)()];
            _company_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _first_name_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _last_name_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _address_1_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _address_2_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _city_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _country_code_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _province_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _postal_code_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _phone_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _metadata_decorators = [(0, swagger_1.ApiPropertyOptional)({ type: Object }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsObject)()];
...
exports.CreateFulfillmentAddressDto = CreateFulfillmentAddressDto;
