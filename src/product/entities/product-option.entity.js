...
exports.ProductOptionSchema = exports.ProductOption = void 0;
...
var ProductOption = function () {
    ...
    var ProductOption = _classThis = /** @class */ (function (_super) {
        ...
        function ProductOption_1() {
            ...
            _this.metadata = (__runInitializers(_this, _title_extraInitializers), __runInitializers(_this, _metadata_initializers, void 0)); // nullable()
            _this.product = (__runInitializers(_this, _metadata_extraInitializers), __runInitializers(_this, _product_initializers, void 0)); // belongsTo(Product)
            _this.values = (__runInitializers(_this, _product_extraInitializers), __runInitializers(_this, _values_initializers, void 0)); // hasMany(ProductOptionValue)
            __runInitializers(_this, _values_extraInitializers);
            return _this;
        }
    ...
    (function () {
        ...
        _values_decorators = [(0, mongoose_1.Prop)({ type: [{ type: mongoose_2.Types.ObjectId, ref: 'ProductOptionValue' }] })];
...
exports.ProductOptionSchema = mongoose_1.SchemaFactory.createForClass(ProductOption);
