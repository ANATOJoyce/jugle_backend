...
var ProductType = function () {
    ...
    var ProductType = _classThis = /** @class */ (function (_super) {
        __extends(ProductType_1, _super);
        function ProductType_1() {
            ...
            _this.products = (__runInitializers(_this, _metadata_extraInitializers), __runInitializers(_this, _products_initializers, void 0));
            __runInitializers(_this, _products_extraInitializers);
            return _this;
        }
        return ProductType_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ProductType");
    (function () {
        var _a;
        ...
        ProductType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductType = _classThis;
}();
