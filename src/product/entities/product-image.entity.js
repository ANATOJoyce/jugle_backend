...
var ProductImage = function () {
    ...
    var ProductImage = _classThis = /** @class */ (function (_super) {
        __extends(ProductImage_1, _super);
        function ProductImage_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.url = __runInitializers(_this, _url_initializers, void 0);
            _this.metadata = (__runInitializers(_this, _url_extraInitializers), __runInitializers(_this, _metadata_initializers, void 0));
            _this.rank = (__runInitializers(_this, _metadata_extraInitializers), __runInitializers(_this, _rank_initializers, void 0));
            _this.product = (__runInitializers(_this, _rank_extraInitializers), __runInitializers(_this, _product_initializers, void 0));
    ...
    (function () {
        ...
        _url_decorators = [(0, mongoose_1.Prop)({ required: true })];
