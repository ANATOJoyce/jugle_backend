...
exports.ProductTagSchema = exports.ProductTag = void 0;
...
var ProductTag = function () {
    ...
    var ProductTag = _classThis = /** @class */ (function (_super) {
        __extends(ProductTag_1, _super);
        function ProductTag_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.value = __runInitializers(_this, _value_initializers, void 0); // searchable and unique
            _this.metadata = (__runInitializers(_this, _value_extraInitializers), __runInitializers(_this, _metadata_initializers, void 0)); // nullable
            _this.products = (__runInitializers(_this, _metadata_extraInitializers), __runInitializers(_this, _products_initializers, void 0)); // manyToMany relationship
            __runInitializers(_this, _products_extraInitializers);
            return _this;
        }
        return ProductTag_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ProductTag");
    (function () {
        var _a;
        ...
        ProductTag = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductTag = _classThis;
}();
exports.ProductTag = ProductTag;
exports.ProductTagSchema = mongoose_1.SchemaFactory.createForClass(ProductTag);
