...
exports.CustomerGroupSchema = exports.CustomerGroup = void 0;
...
var CustomerGroup = function () {
    ...
    var CustomerGroup = _classThis = /** @class */ (function () {
        function CustomerGroup_1() {
            this.id = __runInitializers(this, _id_initializers, void 0); // Préfixe "cusgroup" géré dans le middleware
            ...
            this.deleted_at = (__runInitializers(this, _customers_extraInitializers), __runInitializers(this, _deleted_at_initializers, void 0));
...
exports.CustomerGroupSchema = mongoose_1.SchemaFactory.createForClass(CustomerGroup);
