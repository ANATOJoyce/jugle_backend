...
exports.CustomerAddressSchema = exports.CustomerAddress = void 0;
...
var CustomerAddress = function () {
    ...
    var _address_name_decorators;
    var _address_name_initializers = [];
    var _address_name_extraInitializers = [];
    var _is_default_shipping_decorators;
    var _is_default_shipping_initializers = [];
    var _is_default_shipping_extraInitializers = [];
    var _is_default_billing_decorators;
    var _is_default_billing_initializers = [];
    var _is_default_billing_extraInitializers = [];
    ...
    var CustomerAddress = _classThis = /** @class */ (function () {
        function CustomerAddress_1() {
            this.id = __runInitializers(this, _id_initializers, void 0); // Préfixe "cuaddr" généré automatiquement
            this.address_name = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _address_name_initializers, void 0));
            this.is_default_shipping = (__runInitializers(this, _address_name_extraInitializers), __runInitializers(this, _is_default_shipping_initializers, void 0));
            this.is_default_billing = (__runInitializers(this, _is_default_shipping_extraInitializers), __runInitializers(this, _is_default_billing_initializers, void 0));
            this.company = (__runInitializers(this, _is_default_billing_extraInitializers), __runInitializers(this, _company_initializers, void 0));
            ...
            this.deleted_at = (__runInitializers(this, _customer_extraInitializers), __runInitializers(this, _deleted_at_initializers, void 0));
            __runInitializers(this, _deleted_at_extraInitializers);
        }
        return CustomerAddress_1;
    }());
    __setFunctionName(_classThis, "CustomerAddress");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        _address_name_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _is_default_shipping_decorators = [(0, mongoose_1.Prop)({ default: false })];
        _is_default_billing_decorators = [(0, mongoose_1.Prop)({ default: false })];
        _company_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        ...
        _address_1_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _address_2_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _city_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _country_code_decorators = [(0, mongoose_1.Prop)({ type: String })];
        _province_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _postal_code_decorators = [(0, mongoose_1.Prop)({ type: String, index: true })];
        _phone_decorators = [(0, mongoose_1.Prop)({ type: String })];
        _metadata_decorators = [(0, mongoose_1.Prop)({ type: Object })];
        _customer_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'Customer', required: true })];
        _deleted_at_decorators = [(0, mongoose_1.Prop)()];
        __esDecorate(null, null, _id_decorators, { kind: "field", name: "id", static: false, private: false, access: { has: function (obj) { return "id" in obj; }, get: function (obj) { return obj.id; }, set: function (obj, value) { obj.id = value; } }, metadata: _metadata }, _id_initializers, _id_extraInitializers);
        __esDecorate(null, null, _address_name_decorators, { kind: "field", name: "address_name", static: false, private: false, access: { has: function (obj) { return "address_name" in obj; }, get: function (obj) { return obj.address_name; }, set: function (obj, value) { obj.address_name = value; } }, metadata: _metadata }, _address_name_initializers, _address_name_extraInitializers);
        __esDecorate(null, null, _is_default_shipping_decorators, { kind: "field", name: "is_default_shipping", static: false, private: false, access: { has: function (obj) { return "is_default_shipping" in obj; }, get: function (obj) { return obj.is_default_shipping; }, set: function (obj, value) { obj.is_default_shipping = value; } }, metadata: _metadata }, _is_default_shipping_initializers, _is_default_shipping_extraInitializers);
        __esDecorate(null, null, _is_default_billing_decorators, { kind: "field", name: "is_default_billing", static: false, private: false, access: { has: function (obj) { return "is_default_billing" in obj; }, get: function (obj) { return obj.is_default_billing; }, set: function (obj, value) { obj.is_default_billing = value; } }, metadata: _metadata }, _is_default_billing_initializers, _is_default_billing_extraInitializers);
        ...
        CustomerAddress = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CustomerAddress = _classThis;
}();
