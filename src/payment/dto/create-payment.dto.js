...
var CreatePaymentDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _provider_id_decorators = [(0, class_validator_1.IsString)()];
            _data_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsObject)()];
            _metadata_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsObject)()];
            _captured_at_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDate)()];
            _canceled_at_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDate)()];
            _payment_collection_decorators = [(0, class_validator_1.IsMongoId)()];
            _payment_session_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)()];
            _refunds_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsMongoId)({ each: true })];
            _status_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsIn)(['pending', 'captured', 'refunded'])];
            _captures_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsMongoId)({ each: true })];
