...
var CreateShippingMethodDTO = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateShippingMethodDTO() {
                this.cart_id = __runInitializers(this, _cart_id_initializers, void 0); // 🗂 ID du panier cible
                this.name = (__runInitializers(this, _cart_id_extraInitializers), __runInitializers(this, _name_initializers, void 0)); // ex: UPS, FedEx
                this.amount = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _amount_initializers, void 0)); // ex: 3000 (cents)
                this.description = (__runInitializers(this, _amount_extraInitializers), __runInitializers(this, _description_initializers, void 0)); // texte ou données structurées
                this.metadata = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _metadata_initializers, void 0)); // champ libre
                this.is_tax_inclusive = (__runInitializers(this, _metadata_extraInitializers), __runInitializers(this, _is_tax_inclusive_initializers, void 0)); // true/false
                this.shipping_option_id = (__runInitializers(this, _is_tax_inclusive_extraInitializers), __runInitializers(this, _shipping_option_id_initializers, void 0)); // option liée (si pertinent)
