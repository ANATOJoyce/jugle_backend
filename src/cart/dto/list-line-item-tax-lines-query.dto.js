...
exports.ListLineItemTaxLinesQueryDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var ListLineItemTaxLinesQueryDto = function () {
    var _a;
    var _ids_decorators;
    ...
    return _a = /** @class */ (function () {
            function ListLineItemTaxLinesQueryDto() {
                this.ids = __runInitializers(this, _ids_initializers, void 0);
                this.relations = (__runInitializers(this, _ids_extraInitializers), __runInitializers(this, _relations_initializers, void 0));
            ...
            return ListLineItemTaxLinesQueryDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _ids_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Liste d\'ids CSV' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.split(',');
                })];
            _relations_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Relations à inclure, CSV' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.split(',');
                })];
            _skip_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Nombre de résultats à sauter' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return parseInt(value, 10);
                })];
            _take_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Nombre de résultats à prendre' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return parseInt(value, 10);
                })];
...
exports.ListLineItemTaxLinesQueryDto = ListLineItemTaxLinesQueryDto;
