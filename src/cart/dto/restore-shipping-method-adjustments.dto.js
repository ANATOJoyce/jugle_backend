...
exports.RestoreShippingMethodAdjustmentsDto = void 0;
var class_validator_1 = require("class-validator");
var RestoreShippingMethodAdjustmentsDto = function () {
    var _a;
    var _ids_decorators;
    var _ids_initializers = [];
    var _ids_extraInitializers = [];
    return _a = /** @class */ (function () {
            function RestoreShippingMethodAdjustmentsDto() {
                this.ids = __runInitializers(this, _ids_initializers, void 0);
                __runInitializers(this, _ids_extraInitializers);
            }
            return RestoreShippingMethodAdjustmentsDto;
        }()),
        (function () {
...
exports.RestoreShippingMethodAdjustmentsDto = RestoreShippingMethodAdjustmentsDto;
