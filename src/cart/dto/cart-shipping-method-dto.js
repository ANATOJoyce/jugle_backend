...
exports.CartShippingMethodDTO = void 0;
var class_transformer_1 = require("class-transformer");
var CartShippingMethodDTO = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
            function CartShippingMethodDTO() {
                this.id = __runInitializers(this, _id_initializers, void 0); // ID du ShippingMethod
                ...
                this.cart_id = (__runInitializers(this, _amount_extraInitializers), __runInitializers(this, _cart_id_initializers, void 0)); // ID du panier
                this.description = (__runInitializers(this, _cart_id_extraInitializers), __runInitializers(this, _description_initializers, void 0));
                ...
                this.created_at = (__runInitializers(this, _shipping_option_id_extraInitializers), __runInitializers(this, _created_at_initializers, void 0));
                this.updated_at = (__runInitializers(this, _created_at_extraInitializers), __runInitializers(this, _updated_at_initializers, void 0));
                __runInitializers(this, _updated_at_extraInitializers);
            }
            CartShippingMethodDTO.toObject = function () {
                throw new Error('Method not implemented.');
            };
            return CartShippingMethodDTO;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [(0, class_transformer_1.Expose)()];
            _name_decorators = [(0, class_transformer_1.Expose)()];
            _amount_decorators = [(0, class_transformer_1.Expose)()];
            _cart_id_decorators = [(0, class_transformer_1.Expose)()];
            _description_decorators = [(0, class_transformer_1.Expose)()];
            _metadata_decorators = [(0, class_transformer_1.Expose)()];
            _is_tax_inclusive_decorators = [(0, class_transformer_1.Expose)()];
            _shipping_option_id_decorators = [(0, class_transformer_1.Expose)()];
...
exports.CartShippingMethodDTO = CartShippingMethodDTO;
