...
exports.TaxRegionSchema = exports.TaxRegion = void 0;
var mongoose_1 = require("@nestjs/mongoose");
var mongoose_2 = require("mongoose");
var TaxRegion = function () {
    ...
    var _tax_rates_decorators;
    var _tax_rates_initializers = [];
    var _tax_rates_extraInitializers = [];
    var _deleted_at_decorators;
    var _deleted_at_initializers = [];
    var _deleted_at_extraInitializers = [];
    var TaxRegion = _classThis = /** @class */ (function (_super) {
        __extends(TaxRegion_1, _super);
        function TaxRegion_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.country_code = __runInitializers(_this, _country_code_initializers, void 0);
            _this.province_code = (__runInitializers(_this, _country_code_extraInitializers), __runInitializers(_this, _province_code_initializers, void 0));
            _this.metadata = (__runInitializers(_this, _province_code_extraInitializers), __runInitializers(_this, _metadata_initializers, void 0));
            ...
            _this.provider = (__runInitializers(_this, _created_by_extraInitializers), __runInitializers(_this, _provider_initializers, void 0));
            _this.parent = (__runInitializers(_this, _provider_extraInitializers), __runInitializers(_this, _parent_initializers, void 0));
            _this.children = (__runInitializers(_this, _parent_extraInitializers), __runInitializers(_this, _children_initializers, void 0));
            _this.tax_rates = (__runInitializers(_this, _children_extraInitializers), __runInitializers(_this, _tax_rates_initializers, void 0));
            _this.deleted_at = (__runInitializers(_this, _tax_rates_extraInitializers), __runInitializers(_this, _deleted_at_initializers, void 0));
            __runInitializers(_this, _deleted_at_extraInitializers);
            return _this;
        }
        return TaxRegion_1;
    }(_classSuper));
    __setFunctionName(_classThis, "TaxRegion");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _country_code_decorators = [(0, mongoose_1.Prop)({ required: true, index: true })];
        _province_code_decorators = [(0, mongoose_1.Prop)({ type: String, default: null, index: true })];
        ...
        _provider_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: 'TaxProvider', default: null })];
        _parent_decorators = [(0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: 'TaxRegion', default: null })];
        _children_decorators = [(0, mongoose_1.Prop)({
                type: [{ type: mongoose_2.Schema.Types.ObjectId, ref: 'TaxRegion' }],
                default: [],
            })];
        _tax_rates_decorators = [(0, mongoose_1.Prop)({
                type: [{ type: mongoose_2.Schema.Types.ObjectId, ref: 'TaxRate' }],
                default: [],
            })];
        ...
        __esDecorate(null, null, _tax_rates_decorators, { kind: "field", name: "tax_rates", static: false, private: false, access: { has: function (obj) { return "tax_rates" in obj; }, get: function (obj) { return obj.tax_rates; }, set: function (obj, value) { obj.tax_rates = value; } }, metadata: _metadata }, _tax_rates_initializers, _tax_rates_extraInitializers);
        ...
        TaxRegion = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TaxRegion = _classThis;
}();
exports.TaxRegion = TaxRegion;
exports.TaxRegionSchema = mongoose_1.SchemaFactory.createForClass(TaxRegion);
