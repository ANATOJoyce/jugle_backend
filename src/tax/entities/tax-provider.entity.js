...
exports.TaxProviderSchema = exports.TaxProvider = void 0;
...
var TaxProvider = function () {
    ...
    var TaxProvider = _classThis = /** @class */ (function (_super) {
        __extends(TaxProvider_1, _super);
        function TaxProvider_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.is_enabled = __runInitializers(_this, _is_enabled_initializers, void 0);
            _this.regions = (__runInitializers(_this, _is_enabled_extraInitializers), __runInitializers(_this, _regions_initializers, void 0));
            __runInitializers(_this, _regions_extraInitializers);
            return _this;
        }
        return TaxProvider_1;
    }(_classSuper));
    __setFunctionName(_classThis, "TaxProvider");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _is_enabled_decorators = [(0, mongoose_1.Prop)({ default: true })];
        _regions_decorators = [(0, mongoose_1.Prop)({
        ...
        TaxProvider = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TaxProvider = _classThis;
}();
exports.TaxProvider = TaxProvider;
exports.TaxProviderSchema = mongoose_1.SchemaFactory.createForClass(TaxProvider);
