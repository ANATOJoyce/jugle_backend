...
var denominations_1 = require("./sections/denominations");
var images_1 = require("./sections/images");
var information_1 = require("./sections/information");
var ManageGiftCard = function () {
    var products = (0, medusa_react_1.useAdminProducts)({
        is_giftcard: "true",
    }, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    updateGiftCard.mutate((0, mappers_1.formValuesToUpdateGiftCardMapper)(newData), {
                        onSuccess: function () {
                            setSubmitting(false);
    ...
    return (<gift_card_form_context_1.GiftCardFormProvider giftCard={(0, mappers_1.giftCardToFormValuesMapper)(giftCard)} onSubmit={onSubmit}>
      <div className="flex flex-col gap-y-large pb-xlarge">
        <information_1.default giftCard={giftCard}/>
        <denominations_1.default giftCard={giftCard}/>
        <images_1.default />
      </div>
      <UpdateNotification isLoading={submitting}/>
    </gift_card_form_context_1.GiftCardFormProvider>);
};
var TOAST_ID = "edit-gc-dirty";
var UpdateNotification = function (_a) {
    var _b = _a.isLoading, isLoading = _b === void 0 ? false : _b;
    var _c = (0, gift_card_form_context_1.useGiftCardForm)(), formState = _c.formState, onSubmit = _c.onSubmit, handleSubmit = _c.handleSubmit, resetForm = _c.resetForm, additionalDirtyState = _c.additionalDirtyState;
...
exports.default = ManageGiftCard;
