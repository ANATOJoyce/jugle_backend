...
var Images = function () {
    var _a = (0, gift_card_form_context_1.useGiftCardForm)(), images = _a.images, setImages = _a.setImages, appendImage = _a.appendImage, removeImage = _a.removeImage, control = _a.control;
    return (<body_card_1.default title="Images" subtitle="Add up to 10 images to your Gift Card">
