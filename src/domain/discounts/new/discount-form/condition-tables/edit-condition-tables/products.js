...
var EditProductConditionSelector = function (_a) {
    var _b;
    ...
    return (<>
      ...
      <modal_1.default.Footer isLargeModal>
        <edit_condition_footer_1.default type="products" items={items} operator={operator} onClose={onClose}/>
      </modal_1.default.Footer>
    </>);
};
exports.default = EditProductConditionSelector;
