...
var EditCustomerGroupConditionSelector = function (_a) {
    var _b;
    ...
    var _c = (0, react_1.useState)(((_b = conditions.customer_groups) === null || _b === void 0 ? void 0 : _b.items) || []), items = _c[0], setItems = _c[1];
    ...
    return (<>
      ...
      <modal_1.default.Footer isLargeModal>
        <edit_condition_footer_1.default type="customer_groups" items={items} operator={operator} onClose={onClose}/>
      </modal_1.default.Footer>
    </>);
};
exports.default = EditCustomerGroupConditionSelector;
