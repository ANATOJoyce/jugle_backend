...
var AddCollectionConditionSelector = function (_a) {
    var _b;
    ...
    return (<>
      ...
      <modal_1.default.Footer isLargeModal>
        <add_condition_footer_1.default type="product_collections" items={items} onClose={onClose} operator={operator}/>
      </modal_1.default.Footer>
    </>);
};
exports.default = AddCollectionConditionSelector;
