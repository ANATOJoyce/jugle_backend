...
var DetailsCollectionConditionSelector = function (_a) {
    var _b;
    ...
    (0, react_1.useEffect)(function () { }, [conditions]);
    ...
    return (<>
      ...
      <modal_1.default.Footer isLargeModal>
        <details_condition_footer_1.default type="product_collections" items={items} onClose={onClose} operator={operator}/>
      </modal_1.default.Footer>
    </>);
};
exports.default = DetailsCollectionConditionSelector;
