...
var DetailsProductConditionSelector = function (_a) {
    var _b;
    ...
    return (<>
      ...
      <modal_1.default.Footer isLargeModal>
        <details_condition_footer_1.default type="products" items={items} onClose={onClose} operator={operator}/>
      </modal_1.default.Footer>
    </>);
};
exports.default = DetailsProductConditionSelector;
