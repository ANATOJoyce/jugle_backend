...
var TOAST_ID = "new-product-dirty";
var NewProductPage = function () {
    ...
    var onSubmit = function (data, viewType) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    createProduct.mutate((0, mappers_1.formValuesToCreateProductMapper)(newData, viewType, isFeatureEnabled), {
                        onSuccess: function (_a) {
                            var product = _a.product;
                            setIsLoading(false);
                            notification("Success", "Product was succesfully created", "success");
                            (0, gatsby_1.navigate)("/a/products/".concat(product.id));
                        },
    ...
    return (<product_form_context_1.ProductFormProvider onSubmit={onSubmit}>
      <product_form_1.default />
...
var SaveNotification = function (_a) {
    ...
    var onPublish = function (values) {
        onSubmit(__assign(__assign({}, values), { status: "published" }));
        resetForm();
    };
    var onSaveDraft = function (values) {
        onSubmit(__assign(__assign({}, values), { status: "draft" }));
        resetForm();
    };
    ...
    return (<declarative_toaster_1.default visible={visible} duration={Infinity} id={TOAST_ID} position="bottom-right">
      <form_toaster_1.default isLoading={isLoading}>
        <form_toaster_1.default.Actions>
          <form_toaster_1.default.MultiActionButton actions={[
            {
                label: "Save and publish",
                onClick: handleSubmit(onPublish, handle_form_error_1.handleFormError),
            },
            {
                label: "Save as draft",
                onClick: handleSubmit(onSaveDraft, handle_form_error_1.handleFormError),
            },
        ]}>
            Save
          </form_toaster_1.default.MultiActionButton>
