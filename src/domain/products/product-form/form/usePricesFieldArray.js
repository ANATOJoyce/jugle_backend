...
var usePricesFieldArray = function (currencyCodes, _a, options) {
    var control = _a.control, name = _a.name, keyName = _a.keyName;
    if (options === void 0) { options = {
        defaultAmount: 1000,
        defaultCurrencyCode: "usd",
    }; }
    var defaultAmount = options.defaultAmount, defaultCurrencyCode = options.defaultCurrencyCode;
...
exports.default = usePricesFieldArray;
